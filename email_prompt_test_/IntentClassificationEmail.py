...
def process_email_classifications(file_path, GPT):
    ...
    for row in range(2, sheet.max_row + 1):
        ...
        if intent.lower() not in ["others", "banter"]:
            ...
            if sub_intent in Others.get(intent):
                final_intent = "OTHERS"
            else:
                final_intent = intent
...
file_path = '/home/saiprakesh/PycharmProjects/Prompt Testing Using Excel/email_prompt_test_/automation_testing_email.xlsx'
